...
type Filters struct {
    ...
    ReleasedAfter  *utils.Date `json:"released_after"`
    ReleasedBefore *utils.Date `json:"released_before"`
}
...
func parseReleaseDateAfterFilter(params map[string][]string) *utils.Date {
...
func parseReleaseDateBeforeFilter(params map[string][]string) *utils.Date {
