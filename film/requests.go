...
type CreateFilmRequest struct {
	...
	ReleaseDate utils.Date `json:"release_date" validate:"required,date"`
...
type UpdateFilmRequest struct {
	...
	ReleaseDate utils.Date `json:"release_date" validate:"omitempty,date"`
	Genre       Genre      `json:"genre" validate:"omitempty,genre"`
	Director    string     `json:"director" validate:"omitempty,min=1,max=255"`
	Cast        []string   `json:"cast" validate:"omitempty,min=1,max=100,dive,min=1,max=255"`
