...
VALUES
    ...
    (1, 'Inception', '2010-07-16', 'fantasy', 'Christopher Nolan', 'Leonardo DiCaprio;Joseph Gordon-Levitt;Elliot Page', 'A thief who enters the dreams of others to steal secrets is given the inverse task of planting an idea into the mind of a CEO.'),
    (1, 'The Matrix', '1999-03-31', 'fantasy', 'The Wachowskis', 'Keanu Reeves;Laurence Fishburne;Carrie-Anne Moss', 'A computer hacker learns from mysterious rebels about the true nature of his reality and his role in the war against its controllers.'),
    ...
    (1, 'Interstellar', '2014-11-07', 'fantasy', 'Christopher Nolan', 'Matthew McConaughey;Anne Hathaway;Jessica Chastain', 'A team of explorers travel through a wormhole in space in an attempt to ensure humanity''s survival.'),
    ...
    (1, 'Schindler''s List', '1993-12-15', 'drama', 'Steven Spielberg', 'Liam Neeson;Ralph Fiennes;Ben Kingsley', 'In German-occupied Poland during World War II, industrialist Oskar Schindler gradually becomes concerned for his Jewish workforce after witnessing their persecution by the Nazis.'),
